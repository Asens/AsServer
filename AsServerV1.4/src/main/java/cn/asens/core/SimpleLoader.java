...
import cn.asens.Loader;
import cn.asens.connector.http.Constants;
...
public class SimpleLoader implements Loader,Lifecycle {
    private static Logger log=Logger.getLogger(SimpleLoader.class);
